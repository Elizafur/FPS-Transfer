...
public class WithinSightLoop : Conditional
{
   ...
   public override TaskStatus OnUpdate()
   {
      ...
      for (int i = 0; i < possibleTargets.Length; ++i) {
         if (_WithinSight(possibleTargets[i], fieldOfViewAngle)) {
   ...
   public bool _WithinSight(Transform targetTransform, float fieldOfViewAngle)
   {
